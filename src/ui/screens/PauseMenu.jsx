...
export default function PauseMenu({onResume, onSave, onLoad, onSettings, onQuit, over}) {
    ...
    return (
        <div className={overlay({placement: "center"})}>
            <div className={cn(card(), "animate-[dbPop_240ms_var(--ease-out-db)] motion-reduce:animate-none w-[min(300px,90vw)] text-center")} ref={ref} tabIndex={-1} role="dialog" aria-modal="true"
