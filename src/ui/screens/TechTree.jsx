...
export default function TechTree({world, api, mySlot, onClose}) {
    ...
    return (
        <div className="db-techtree absolute top-[34px] inset-x-0 bottom-0 z-40 flex flex-col bg-[rgba(4,6,9,0.62)] backdrop-blur-[6px] border border-line rounded-none shadow-[0_26px_80px_rgba(0,0,0,0.6)] overflow-hidden animate-[dbRowIn_220ms_var(--ease-out)_both] motion-reduce:animate-none"
