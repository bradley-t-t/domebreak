...
export default function StartMenu({
    ...
    return (
        ...
        <div className="absolute inset-0 z-10 block overflow-hidden p-0">
            ...
            <aside className="absolute top-0 left-0 bottom-0 w-96 max-w-[84vw] flex flex-col pt-[46px] pr-[46px] pb-[26px] pl-10 text-left pointer-events-none animate-[gdRailIn_520ms_var(--ease-out-gd)_both] motion-reduce:animate-none
                ...
                <div className="mb-[34px]">
                    ...
                    <h1 className="text-[46px] tracking-[8px] leading-[0.96] text-dim">
                        GOLDEN<span className="block text-text [text-shadow:var(--glow-gold)] animate-[gdTitleGlow_6s_var(--ease-in-out)_infinite_alternate]">DOME</span>
                    </h1>
