...
const FEATURES = [
    ...
    {icon: "spacehq", title: "Rival powers", body: "Up to eight rival powers each run their own economy, defenses, and doctrine, and react to what you do. No two matches play out the same."},
