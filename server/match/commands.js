...
export const COMMANDS = {
    ...
    setFollow: (w, slot, [uid, tid]) => setFollow(w, slot, str(uid, 64), str(tid, 64)),
    stopFollow: (w, slot, [uid]) => stopFollow(w, slot, str(uid, 64)),
    ...
    setStance: (w, slot, [uid, stance]) => setStance(w, slot, str(uid, 64), str(stance)),
